...
public class InformalsFragment extends Fragment {
    public static final String TAG = InformalsFragment.class.getSimpleName();

    private static final String ABOUT_SCHEME = "category";
    private static final String ABOUT_AUTHORITY = "inf";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(int i=0;i<MainTileActivity.EventsCollection.size();i++) {
            if(MainTileActivity.EventsCollection.get(i).getEventCategory().equals("Informals")) {
