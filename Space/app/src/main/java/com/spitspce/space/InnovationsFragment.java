...
public class InnovationsFragment extends Fragment {
    public static final String TAG = InnovationsFragment.class.getSimpleName();

    private static final String ABOUT_SCHEME = "category";
    private static final String ABOUT_AUTHORITY = "inno";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(int i=0;i<MainTileActivity.EventsCollection.size();i++) {
            if(MainTileActivity.EventsCollection.get(i).getEventCategory().equals("Innovations")) {
